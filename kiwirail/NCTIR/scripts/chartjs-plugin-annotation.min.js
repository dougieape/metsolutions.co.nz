...
module.exports = function(Chart) {
    ...
    var LineAnnotation = Chart.Annotation.Element.extend({
        ...
        configure: function() {
            ...
            model.rotation = options.label.rotation
        ...
        draw: function() {
            ...
            if (view.labelEnabled && view.labelContent) {
                ...
                ctx.rotate(isNaN(Math.PI/180*view.rotation)? 0:Math.PI/180*view.rotation);
                lC = view

                view.labelContent.forEach(function(f,e){
                    ctx.fillText(f, lC.labelX, lC.labelY + lC.labelHeight / 2 + (e*15))
                });
            }
